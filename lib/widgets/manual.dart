...
const manualList = [
  MaunalModel("https://placehold.co/600x400", "1", "크게 소리를 질러 주변에 도움을 요청"),
  MaunalModel(
      "https://placehold.co/600x400", "2", "물건이나 주변 시설을 두드려 소음을 내어 응급상황 알리기"),
  MaunalModel("https://placehold.co/600x400", "3", "한쪽 벽이나 이동 손잡이 등을 이용하여 이동"),
  MaunalModel("https://placehold.co/600x400", "4",
